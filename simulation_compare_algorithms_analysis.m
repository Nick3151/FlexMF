...
nSim = 100;
K = 10;
num_detected_SeqNMF = zeros(1,K);
num_significant_SeqNMF = zeros(1,K);
num_detected_FlexMF = zeros(1,K);
num_significant_FlexMF = zeros(1,K);
coeffs_SeqNMF = nan(nSim, K);
coeffs_FlexMF = nan(nSim, K);
coeffs_SeqNMF_significant = nan(nSim, K);
coeffs_FlexMF_significant = nan(nSim, K);
is_significant_SeqNMF = logical(is_significant_SeqNMF);
is_significant_FlexMF = logical(is_significant_FlexMF);
...
for i=1:nSim
    ...
    num_detected_SeqNMF(ids_SeqNMF) = num_detected_SeqNMF(ids_SeqNMF)+1;
    num_detected_FlexMF(ids_FlexMF) = num_detected_FlexMF(ids_FlexMF)+1;

    ids_SeqNMF_significant = ids_SeqNMF(is_significant_SeqNMF(i,1:length(ids_SeqNMF)));
    ids_FlexMF_significant = ids_FlexMF(is_significant_FlexMF(i,1:length(ids_FlexMF)));
    ...
    coeffs_SeqNMF(i,ids_SeqNMF) = coeff_SeqNMF;
    coeffs_FlexMF(i, ids_FlexMF) = coeff_FlexMF;

    coeffs_SeqNMF_significant(i,ids_SeqNMF_significant) = coeff_SeqNMF(is_significant_SeqNMF(i,1:length(ids_SeqNMF)));
    coeffs_FlexMF_significant(i, ids_FlexMF_significant) = coeff_FlexMF(is_significant_FlexMF(i,1:length(ids_FlexMF)));
end
