...
%% Shape conditions
sel = 2;
simulation_compare_algorithm_plot('simulate_results_shape.mat', 3, {'Calcium transients', 'Bursts', 'Single spikes'}, sel)
...
sel = 3;
simulation_compare_algorithm_plot("simulate_results_participate.mat", 5, ...
