...
% save2pdf('Simulation_results_min_motif_occur_shape', f4);
...
% save2pdf('Simulation_results_min_motif_occur_noise', f4);
...
% save2pdf('Simulation_results_min_motif_occur_participate', f4);
...
% save2pdf('Simulation_results_min_motif_occur_jittering', f4);
...
% save2pdf('Simulation_results_min_motif_occur_warping', f4);
...
% save2pdf('Simulation_results_min_motif_occur_overlap', f4);
