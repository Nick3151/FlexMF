...
%   'lambda'          0.1     SeqNMF overlap penalty
%   'lambda_FlexMF'   0.5     FlexMF overlap penalty
%   'lambda_M'        0.1
%   'lambda_R'        1
...
addParameter(p, 'lambda_FlexMF', 0.5, @isnumeric);
...
lambda = opt.lambda;
lambda_FlexMF = opt.lambda_FlexMF;
...
if useParallel
    parfor n = 1:nSim
        [seqNMF_W{n}, seqNMF_H{n}, W_rand{n}, H_rand{n}, M_rand{n}, R_rand{n}, ...
            ...
            ids_match(n,:), constraints_rel(n,:)] = compare_init_one_restart( ...
            Xtrain, Xtest, Wd, Htrain, ...
            Khat, Ld, lambda, lambda_FlexMF, lambda_M, lambda_R, lambdaL1H, ...
...
if opt.saveResults
    ...
    save(resultsFile, 'results', 'data', 'methodLabels', 'nSim', 'K', 'Khat', ...
        'lambda', 'lambda_FlexMF', 'lambda_M', 'lambda_R', 'maxiter', 'tolerance', ...
...
function [W0, H0, Wr, Hr, Mr, Rr, Ww, Hw, Mw, Rw, Wwr, Hwr, Mwr, Rwr, ...
    ...
    eWrow, eHrow, nDetRow, nSigRow, pvalsRow, isigRow, idsRow, cRelRow] = ...
    ...
    nIt_w = numel(costw) - 1;
    obj_w = lambda_FlexMF * errorsw(end, 2) + ...
    ...
    obj_wr = lambda_FlexMF * errorswr(end, 2) + ...
    ...
    [Wr, Hr, costr, errorsr, ~, ~, Mr, Rr] = FlexMF(Xtrain, ...
        ...
        'showPlot', 0, 'verbal', 0);
    nIt_r = numel(costr) - 1;
    obj_r = lambda_FlexMF * errorsr(end, 2) + ...
    ...
    for m = 1:nMethod
        ...
        if m == 1
            ...
            [Wtest, ~, ~, ~, ~, ~, M_test, ~] = FlexMF(Xtest, ...
                ...
                'EMD', 1, 'lambda', lambda_FlexMF, 'lambda_M', lambda_M, ...
